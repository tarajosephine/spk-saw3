...
class Admin extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['peserta'] = $this->db->query("SELECT * from peserta")->num_rows();
		$data['jenis_usaha'] = $this->db->query("SELECT * from jenis_usaha")->num_rows();
		$data['sub_ju'] = $this->db->query("SELECT * from subjenis_usaha")->num_rows();
