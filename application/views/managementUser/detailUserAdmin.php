            ...
            <div class="col-lg-6">
                <div class="card shadow mb-4 border-bottom-success">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Detail User Admin</h6>
                    </div>
                    <div class="card-body">
                        <p>Data diri Admin.</p>
                        <div class="mb-2">
                        ...
                        <div class="mt-4 mb-2">
                            <label class="small font-weight-bold" for="role">Role</label>
                            <p><?= $user['role']; ?></p>
                        </div>
                        <div class="mt-4 mb-2">
                ...
                <div class="card shadow mb-4 border-bottom-success">
                    ...
                    <div class="card-body">
                        <div class="col-md-6">
                            ...
                            <img src="<?= base_url('assets/img/profile/') . $user['image']; ?>" class="card-img mx-auto d-block">
                        </div>
                    </div>
                </div>
            </div>
